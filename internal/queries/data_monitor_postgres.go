...
// DataMonitorPairsSQLPostgres содержит SQL-запрос для получения пар (EXCHANGE_ID, PAIR_ID, SYMBOL, MARKET_TYPE) для DataMonitor (PostgreSQL)
const DataMonitorPairsSQLPostgres = `
SELECT 
    stp.EXCHANGE_ID,
